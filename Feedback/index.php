	...
	<section div id="content_container">
		<h1><img src="../template/template_image/header/feedback.png"></h1>
			<section div class="auction_container">	
				<div id="feedback">
				<ul>
					<section div class="column_first">
						<p>Feel free to email us at <a href="mailto:support@coincod.com">support@coincod.com</a></p>
						<form accept-charset="UTF-8" action="/contact" class="edit_user" id="edit_user_1809494" method="post">
							<div style="margin:0;padding:0;display:inline"><input name="_method" value="put" type="hidden">
							</div>

							<dl class="form">
								<dt><label for="form_name">Name</label></dt>
								<dd><input id="form_name" name="form[name]" value="" type="text"></dd>
							</dl>

							<dl class="form">
								<dt><label for="form_email">Email</label></dt>
								<dd><input id="form_email" name="form[email]" required="true" value="" type="text"></dd>
							</dl>

							<dl class="form">
								<dt><label for="form_subject">Subject</label></dt>
								<dd><input id="form_subject" name="form[subject]" required="true" type="text"></dd>
							</dl>
							...
							<dl class="form">
								...
								<dd><textarea id="form_comments" name="form[comments]" placeholder="Please write your feedback here. We will reply your feedback as soon as possible." required="true"></textarea></dd>
							</dl>
