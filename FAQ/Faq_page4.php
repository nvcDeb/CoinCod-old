...
<div id="wrapper">
	...
	?>
     <div id="content_container">
		...
		<li><a name="Question16"><strong>What happens when I win?</strong></a></li>
...
Note: Product cost refers to the final cost of product at which bidding stopped. It is referred on CoinCod as "Current price". It is NOT the retail price of the item.
		...
		<li><a name="Question17"><strong>How can I buy bids on CoinCod?</strong></a></li>
        At present you can buy bid packages online. Bid packages can be purchased using all e-payment methods that are supported by our electronic payments trading partner NetBuilder.com.my
		<ul>
		<li>Visa</li>
		<li>Mastercard</li>
		...
		<li><a name="Question18"><strong>How long are the free bids valid for?</strong></a></li>
		...
		<li><a name="Question19"><strong>I have bought bids and there is a balance on my account. How long are my bids valid for?</strong></a></li>
        There are no expiry date for the bids. They are valid as long as the user keeps their account registered in our database.
		</br></br>
        
		<li><a name="Question20"><strong>Can I get a refund for unused bids?</strong></a></li>
