...
function myFunction()
{
alert("Please log in or register to contnue browsing the site!");
}
</script>
						...
						<h4>Paypal (RM)</h4>
								...
								if (isset($_SESSION['user_id'])) {
									...
									echo '<form action="#" method="post">
											<input type="hidden" name="cmd" value="_s-xclick">
											<input type="hidden" name="hosted_button_id" value="'.$i.'">        
											<input type="image" src="http://coincod.com/template/price_button/'.$j.'.png" width="104" height="34" border="0" name="submit" alt="PayPal - The safer, easier way to pay online!" onclick="myFunction()">
											<img alt="" border="0" src="https://www.paypalobjects.com/en_US/i/scr/pixel.gif" width="1" height="1">
										</form>';
								}
								} 
