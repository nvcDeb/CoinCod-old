								...
								foreach ( $array as $i => $j) {
									echo '
										<form action="https://www.paypal.com/cgi-bin/webscr" method="post">
											...
											<input type="image" src="http://auction12345.site50.net/template/price_button/'.$j.'.png" width="104" height="34" border="0" name="submit" alt="PayPal - The safer, easier way to pay online!">
