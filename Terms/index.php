...
ANY PERSON THAT DOES NOT ACCEPT THE TERMS OF SERVICE, AS WELL AS THE MANNER IN WHICH COINCOD AND ITS “AUTOBID” OPERATE AS DESCRIBED ON THE WEBSITE COINCOD.COM, WHICH ARE OF BINDING & MANDATORY CHARACTER, SHALL COMPLETELY ABSTAIN THEMSELVES FROM USING THIS SITE AND OR ITS service. AS A PARTICIPANT OF THE SITE - YOU MUST SATISFY YOURSELF THAT YOUR COUNTRY/STATE ALLOWS YOU TO USE OUR FACILITIES.   COINCOD SITE CANNOT BE HELD RESPONSIBLE FOR PARTICIPANTS FROM COUNTRIES/STATES THAT HAVE RESTRICTIONS.</br>
1.5  Coincod reserves the right to change, modify, or otherwise alter these Terms of service at any time by publishing a relevant notice and the amended and/or added to Conditions on the Site.</br>
1.6  Amendments or additions to the Terms of service shall enter into force immediately upon their publication on the Site.</br>
1.7  You consent to the amendments or modifications to the Terms of service if you use your user account after the amendments or additions have been posted on the Site.</br>
...
2.13 Employees and relatives of employees of Coincod are not eligible to participate in Coincod auctions under any circumstances.
        ...
        <strong>3.    Auction Process / How the Auction Works: </strong></br>
        3.1 The opening price of each item is 25% lower than the original market price. At start, the price of the item shall decrease(RM0.01) with each 1 token bid. After a certain period of time the token to bid will increase, and the price decrease will follow the amount of token. When the decrement price reaches RM0.00 each continuous bid will increase the price of the product. The increment will also follow the amount of tokens placed on the bid.  The bidding time (hereinafter Bidding Time) will be displayed near the item being sold at the Auction. Each new bid extends the bidding time by extending the remaining time because the bidding time starts anew after every bid.</br>
3.2  The Auction ends when no bids are received within the time specified on the Site and the time reaches zero. At the end of the Auction, you will be considered the winning bidder only if you submitted the last bid during the Bidding Time. If you are the winning bidder, your username will be displayed in a box near the item sold at the Auction, and an enforceable sales contract for the item sold at the Auction shall be deemed concluded between Coincod and you. All other bids placed on the item expire and will not be credited back to the Participant’s account or be eligible for a refund.</br>
3.3  You agree that if you are the winning bidder you will pay the final price(or coincod will pay you) for the item within seven (7) days after receiving of a confirmation e-mail. If you fail to pay for the item by the specified due date, Coincod will withdraw from the sales contract for the item without any notice. Any Participant, who wants to partake in one of the auctions and submits a bid (a participation request) to Coincod for a single auction, must pay for such a submitted bid regardless of whether that bid is the winning bid at the end of the single auction or not.</br>
3.4  Every bid submitted by a Participant for a specific auction constitutes an offer from that Participant to Coincod, to conclude a contract for the purchase of the auctioned item. The final and binding contract will only be finalized:</br>
3.4.1- With the Participant who has submitted the highest bid as the last bidder, once the Countdown for the relevant single auction is finished; and</br>
3.4.2 - Once such Participant receives the Confirmation Message from Coincod as outlined in section 7 herein below.</br>
3.5  The last bidder is determined based on the records in Coincod’s auction database, and Coincod’s decision regarding who the winning bidder is shall be final (except in the case of manifest error). All other bids on the auctioned item expire and will not be refunded.</br>
3.6  If you are the winning bidder, an invoice including the auction ending price will be sent to your e-mail address. Coincod shall arrange the delivery of the purchased item to the mailing address provided by you within fourteen (14) business days from the date on which the Seller’s full payment has been received. Buyer will have to pay for shipping and handling.</br>
3.7  When you take part in the auction of electronic devices, make sure that the device works in your region.</br>
...
4.9  Credits used to make bids are not refundable. NO EXCEPTIONS. Customer should only buy as many bids as the Customer is comfortable spending on the Auction.
        ...
        <strong>6.    Currency of the transactions:</strong></br>

6.1  At the moment the currency of all transactions related to service provided by Coincod is Ringgit Malaysia ($,RM).
		</br></br>
        
		<strong>7.    Acceptance of the Win / Payment:</strong></br>

7.1  After a single auction has ended, the last bidder (the “Winner”) will receive a confirmation message by email, indicating that he has won a specific auction, and also including the final auction price for the auctioned item (the “Confirmation e-mail”).</br>
7.2  With the receipt of the Confirmation e-mail by the Winner, the contract for the purchase of the auctioned item between Coincod and the Winner becomes effective, and the payment of the final auction price becomes due for payment by the Winner.</br>
7.3  In the event the Winner does not (within seven (7) days from the receipt of the Confirmation e-mail), transfer the final auction price to the Coincod bank accounts, as stated in the Confirmation e-mail, it is deemed that the Winner has revoked the contract, and Coincod reserves the right to withdraw the offer to conclude a contract and the winner’s right to pay for and receive delivery of an item will be permanently revoked. As a consequence, the Winner has permanently forfeited any title to claim delivery of the auctioned item. Furthermore, the Winner is not entitled to request a replacement for the Bids used for the relevant single auction.</br>
7.4  The shipment of the auctioned item to the Winner will be made by Coincod only after the final auction price has been paid by the Winner and credited to the bank account of Coincod; and furthermore there must be no cancellations from Payment Agents related to the Winner’s purchase of Bids. In the event that the final payment for Bids, which have been purchased and used by a winning Participant, should fail or be cancelled by the Participant’s Payment Agent, any pending or future payments received from that Participant for purchase of Bids shall be viewed as relating to such previous unpaid Bids.</br>
7.5  Coincod will exercise a right of retention pertaining to delivery of an auctioned item to such winning Participant as long as all relevant Bids and the Final Auction Price for the respective single auction have been paid for in full. Any other rights of Coincod, such as late payment fees or storage charges, are reserved.     </br>   
7.6  Payment can be made by credit card or via payment agent such as PayPal.</br>
7.7  The Participant has right of withdrawal of auctioned goods within 7 days from the closed auction.
		</br></br>
        
		<strong>8.    Delivery</strong></br>

8.1  The product, a certificate, or other means of entitlement that allows the Winning Bidder to receive the offered product will be shipped to the address that was provided by the Winning Bidder in their Member profile at the time their payment was submitted.</br>
8.2  Coincod will determine the method of delivery at its sole discretion and such delivery shall completely fulfill Coincod's obligation to supply the product to the Winning Bidder. Coincod may use third parties for the performance of any of its contractual duties, and is not obliged to notify the winning Participant in advance when doing so.</br>
8.3  Coincod reserves the right to deliver a similar product of equivalent value available locally at a winner’s resident state or country.</br>
8.4  The Winning Bidder may not make any claim nor file any complaint against Coincod with regards to not receiving a product offered in an Auction, because of, but not limited to, a change of shipping address as submitted by the Winning Bidder and/or by providing an incorrect and/or inaccurate address.</br>
8.5  Unless otherwise stated, delivery will be made directly from Coincod to the address provided by the Participant. Delivery times vary and any delivery time indicated is provided only as a guide and is not guaranteed.</br>
8.6  Coincod will deliver or arrange the delivery of the product, a certificate, or other means entitling the Winning Bidder to receive the product at a agreed upon location within fourteen (14) business days, from the day that Winning Bidder meets the requirements for product delivery as described herein this Participants Agreement, unless otherwise stated by Coincod.</br>
8.7  The Winning Bidder authorizes Coincod to extend the delivery date for any reason that is outside of theCoincod's control or responsibility and/or for any reason that relates to third parties including suppliers and delivery agents.</br>
8.8  Coincod will not be held responsible for non essential differences between the descriptions publicized by Coincod in an Auction and the actual products that are provided. The term "non essential differences" refers to inconsistencies that do not change the general purpose of the product. If the description of a specific product differs essentially from the actual product delivered, the Winning Bidder will have the right to accept the product as is or cancel the Winning Bid and receive a refund of all fees and payments that were billed for that Auction and this will be the sole claim of the Participant against Coincod. The product may differ from the images provided.</br>
8.9  Coincod reserves the right to deliver a similar product of equivalent value available locally at a winner’s resident state or country.</br> 
8.10 When the auction closes, the final price of the item, delivery and handling cost will be added. The delivery cost depends on the address the winner has inserted in their Coincod profile. Usually estimated delivery costs have been listed at each auction. If the delivery cost to your address has not been listed, contact us at support@coincod.com</br>
8.11 Coincod makes no representations or warranties as to any of the products and/or service provided in the Auction and no claims may be made against Coincod  based upon the products provided.</br>
8.12 All items on Coincod are brand new, all product warrantees will be provided (if provided) by the actual distributors, manufacturers, and/or providers of products and/or service. No claims may be made against Coincod for defective products and or service.</br>
8.13 If Coincod is unable to deliver the auctioned item to the winning Participant, and such inability is not caused by Coincod but through a failure in performance or a delayed performance by an external supplier of Coincod, Coincod may, at its sole discretion, either replace the auctioned item with a comparable substitute or one with better features, or rescind the contract with the winning Participant. Any statutory rights of the winning Participant shall remain unaffected.   
        ...
        <strong>9.   Returns and Cancellation</strong></br>
        9.1 No refund unless the product is faulty
        </br></br>
        
        <strong>10. Offsetting / Withholding Payment / Retention of Title</strong></br>

10.1  The Participant shall only have the right to offset if his or her counterclaims are not disputed by Coincod.</br>
10.2  The Participant is not entitled by reason of any alleged minor defect to withhold more than a proportionate amount of the sum due.</br>
...
11.9.5 PLEASE NOTE: THERE ARE TIMES WHEN WE NEED TO TAKE THE SITE DOWN FOR THE ABOVE REASONS. BE ASSURED - YOU WILL NOT BE AFFECTED IF WE TAKE THE SITE DOWN.
		...
		<strong>12. Disclaimer of Warranty and Limitation of Liability regarding Purchases from Coincod.</strong></br> 

12.1  All items on Coincod are brand new and are sold with the manufacturer's limited warranty only, all product warrantees will be provided (if provided) by the actual distributors, manufacturers, and/or providers of products and/or service. No claims may be made against  Coincod for defective products and or service.</br>
12.2  Coincod warrants solely that the products sold to Participants under these terms shall have the characteristics specified in  Coincod’s specifications for such Products as set forth in the description of each auction and assumes no further warranties. The warranty period and service varies by manufacturer and product.</br>
12.3  Except for the warranties set forth above  Coincod makes no other warranties, either express or implied, with respect to the products, or any related service performed by  Coincod or any of its agents or subcontractors in connection with any order, including, without limitation, any warranties of fitness for a particular purpose, which other warranties are expressly excluded and disclaimed. Please keep in mind that the product may differ from the images provided in each auction page.</br>
12.4  Coincod makes no representations or warranties as to any of the products and/or service provided in the Auction and no claims may be made against  Coincod based upon the products provided.</br>
12.5  Coincod shall not be liable for personal injury and property damage resulting from the improper handling, modification, and misuse of the products by the Participant or any other person following delivery by  Coincod. In no event shall  Coincod be liable to any person for incidental or consequential damages including but not limited to loss of profits or goodwill, loss-of-use damages or additional expenses incurred, whether pursuant to a claim in contract, tort or otherwise and whether in an action for breach of warranty or otherwise.
		...
		<strong>13. Illegal Activity</strong></br> 

13.1  The Site only may be used for lawful purposes and in a lawful manner. Participant agrees to comply with all applicable laws, statutes and regulations regarding use of the Site.</br>
13.2  Participant may not register under a false name or use an invalid or unauthorized credit card.</br>
13.3  Participant may not make bids under a false name, impersonate any Participant, or use another Participant's password(s). Such fraudulent conduct is a violation of federal and state laws.</br>
13.4  Fraudulent conduct may be reported to law enforcement, and  Coincod will cooperate to ensure that violators are prosecuted to the fullest extent of the law.</br>
13.5  Without limiting other remedies,  Coincod may immediately issue a warning, temporarily suspend, indefinitely suspend or terminate membership and refuse to provide service to Participant:</br>
(a) if Participant breaches this Agreement or the documents it incorporates by reference; </br>
(b) if  Coincod is unable to verify or authenticate any information Participant provided to  Coincod; or</br>
(c) if  Coincod believes that Participant actions may cause legal liability for other Participants or Coincod.</br>
13.6  Internet fraud is a serious offense. Coincod HAS ZERO TOLERANCE FOR ONLINE FRAUD. Every time you log in to the  Coincod Site, your IP address is recorded. This information can be used against fraudulent bidders. Any acts of online fraud or suspicions thereof, should be immediately reported to Coincod.  Coincod will notify and assist the appropriate law enforcement agencies in any case where there is suspicion of fraudulent use of our Coincod website.  Coincod will terminate and ban the Participant on the first offense.  Coincod will also maintain and enforce a blacklist to chronicle fraudulent Participants. 
		...
		<strong>14. Service and Support for Products Purchased</strong></br>

14.1  All requests for technical service and support should be made directly to the manufacturer in accordance with their Terms of service.</br>
14.2  All items on  Coincod are brand new, all product warrantees will be provided (if provided) by the actual distributors, manufacturers, and/or providers of products and/or service. No claims may be made against  Coincod for defective products and or service.  Coincod makes no representations or warranties as to any of the products and/or service provided in the Auction and no claims may be made against  Coincod based upon the products provided.</br>
14.3  Coincod makes no representations or warranties as to any of the products and/or service provided in the Auction and no claims may be made against  Coincod based upon the products provided.
		...
		<strong>15. Trademarks</strong></br>
...
16.6  Coincod shall not be liable for any damage whatsoever incurred by auction Participants or third parties from using Coincod’s service. In particular, Coincod shall not be liable for damage that occurs due to bids submitted by auction Participants not being received by  Coincod or not being received promptly or not being considered, as a consequence of technical faults.
		...
		<strong>17. No Responsibility for External Internet Links</strong></br>
...
17.1  Our website may contain links to other websites operated by third parties, and these sites may likewise contain links to other websites. Despite conducting careful checks, we assume no liability for the content of external links. The operators of the.1sites linked to and from this site are solely responsible for their contents. We hereby expressly distance ourselves from all content of any and all websites linked to the  Coincod website. We cannot take any responsibility for the content of the data protection guidelines of third-party websites.
		...
		<strong>18. Acceptance of Terms of service</strong></br>
...
18.1  By registering it will be deemed that you have fully read the Terms of service and accepted all Terms of service listed.
		...
		<strong>19. General / Miscellaneous</strong></br>

19.1  Coincod will not be held responsible for the use of Bid details and/or other information given by Participants when submitting Bids, including through the Internet website of  Coincod, by parties that are not  Coincod and/or its employees, including hackers and/or parties that may penetrate the files of  Coincod's website.</br>
19.2  Coincod is not the agent, fiduciary, trustee or other representative of you. Nothing expressed or mentioned in or implied from this Agreement is intended or shall be construed to give to any person other than the parties hereto any legal or equitable right, remedy or claim under or in respect to this Agreement. This Agreement and all of the representations, warranties, covenants, conditions and provisions hereof are intended to be and are for the sole and exclusive benefit of  Coincod and Participants.</br>
19.3  The contract between  Coincod and Participants is binding on the parties and on their respective successors and assigns. The Participant may not transfer, assign, charge or otherwise dispose of any contract formed under these General Terms of service or any of their rights or obligations without Coincod’s prior written consent.</br>
...
19.8  Any comments or materials sent to  Coincod, including feedback data, such as questions, comments, suggestions or similar with regarding the content of any such documents shall be deemed to be non-confidential and non-proprietary.  Coincod shall have no obligation of any kind with respect to such Feedback and shall be free to reproduce, use, disclose, exhibit, display, transform, create derivative works and distribute the Feedback to others without limitation and without compensation to you. Further, Coincod shall be free to use any ideas, concepts, technical knowledge or techniques contained in such Feedback for any purpose whatsoever, including but not limited to, developing, manufacturing and marketing products incorporating such Feedback
		...
		<strong>20. Copyright Release: </strong></br>
		...
		<strong>21.  Interpretation: </strong></br>
		...
		<strong>22. Jurisdiction: </strong></br>
        Normal 0 false false false EN-US ZH-CN X-NONE</br>
The use of the Coincod service on this Website and the Terms of service herein shall be governed by and construed in accordance with the laws of Malaysia and the parties hereby submit to the exclusive jurisdiction of the Courts of Malaysia notwithstanding that the Coincod service on this Website may be accessed in other jurisdiction and not restricted to Malaysia</br>
The Customer hereby agrees that the Customer shall be solely responsible for the compliance with all laws applicable to the Customer in the Customer’s jurisdiction in respect of the use of the Coincod service.
		...
		<strong>23. Termination of Using the service:</strong></br>
You may terminate the use of service and close your user account. However, any contractual obligations incurred before the termination of the account shall remain in full force and effect until you completely discharge them by paying for any outstanding purchases and any applicable taxes or delivery charges.
		...
		<strong>24. Final Provisions:</strong></br>
24.1 In addition to these Terms of service, the relationship between you and Service Provider shall be governed by the Site price list for service.</br>
24.2 If any of the clauses of the present conditions shall be null or voided by judicial or administrative authorities, the other clauses shall not be affected and shall continue to be valid and executed.</br>
24.3 If you have any questions about this site, its Terms of service or its Privacy Policies, please do not hesitate to contact us at support@coincod.com.</br>
Note:</br>
24.4 Due to the billing of charges, Coincod would like to advise all Participants to monitor their bidding practices.</br>
24.5 Placing bids online at  Coincod.com frequently or repeatedly can incur high costs.</br>
24.6 Participants should therefore pay attention to their bidding practices and check their charges regularly.</br>
24.7 By purchasing bids, Coincod does not guarantee that you will win an auction.</br>
24.8 Please remember - Many Participants visit and use Coincod’s website.</br>
24.9 Everyone has the same chance of winning - Every bid counts and can grab you that item.</br>
